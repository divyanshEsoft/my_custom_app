...
app_publisher = "Divyansh"
app_description = "esoft erp custom app "
...
doc_events = {
    "Employee Checkin": {
        "after_insert": [
            ...
            "my_custom_app.api.push_notification.send_checkin_notification"
        ]
    }
}
...
# }
# override_whitelisted_methods = {
#     "my_custom_app.api.leave_api.get_total_leave_requests": "my_custom_app.api.total_leave_request_count.get_total_leave_requests"
# }
